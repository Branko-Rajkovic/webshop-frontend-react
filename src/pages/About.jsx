        ...
        <div className="max-w-4xl p-6 mx-auto">
          ...
          <section className="p-6 mb-6 bg-white rounded-lg shadow-md">
            ...
            <p className="text-gray-600">
              ...
              <strong>[Your Webshop Name]</strong> started with a simple idea:
              to make <strong>[your niche]</strong> shopping easier, more
              affordable, and enjoyable. What began as a small project has grown
              into a trusted online store, serving customers worldwide.
            </p>
          </section>
          ...
          <section className="p-6 mb-6 bg-white rounded-lg shadow-md">
            ...
            <p className="text-gray-600">
              At <strong>[Your Webshop Name]</strong>, we believe shopping
              should be hassle-free and enjoyable. Our mission is to provide a
              seamless online experience, offering trendy, high-quality, and
              affordable products backed by excellent customer service.
            </p>
          </section>
        </div>
        <Footer />
